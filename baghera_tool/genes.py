        ...
        self.table = self.table.append(
            {
                ...
                "stats_max": np.max(non_coding["stats"]),
            },
            ignore_index=True,
        )
